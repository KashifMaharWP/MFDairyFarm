    ...
    actions: [
      InkWell(
        ...
        child: Container(
          ...
          child: Center(child: Text1(fontColor: Colors.white, fontSize: paragraph, text: "Cancel")),
        ),
      ),
      InkWell(
        onTap: (){
        ...
        child: Container(
          ...
          child: Center(child: Text1(fontColor: Colors.white, fontSize: paragraph, text: "Save")),
        ),
      )
    ],
  );
