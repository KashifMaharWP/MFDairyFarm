...
class GlobalApi {
  ...
  static String milkRecordBetweenDates =
      "dashboard/cowAnalyticsBetweenTwoDatescowId/";
  static String monthlyFeedInventory = "feedInventory/month/";
  static String fetchVendorMilkRecord =
      "milkSale/getMilkSaleRecordBtwTwoDatesByVendorId/";
  static String fetchVendorMonthSale =
      "milkSale/getMilkSaleMonthlyRecordByVendorId/";

  static String fetchMilkRecord = "milk/getMilkRecordBetweenTwoDates/";
  static String fetchFeedConsumption =
      "feed/getFeedConsumtionRecordBtwTwoDates/";
